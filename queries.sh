...
echo -e "\nAverage number of goals in all games from the wining teams:"
echo  "$($PSQL "SELECT AVG(winner_goals) FROM games")"

echo -e "\nAverage number of goals in all games from the wining teams rounded to two decimal places:"
...
echo -e "\nWinner of the 2018 tournament tame name:"
